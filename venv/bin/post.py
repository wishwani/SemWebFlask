...
url = 'https://territoire.emse.fr/ldp/sararandika/'
#file_path = '/Users/sathish.bowatta/Documents/M2/iot/SemanticWeb/caloutput.ttl'
...
g = Graph().parse("/Users/sathish.bowatta/Documents/M2/iot/SemanticWeb/caloutput.ttl")
g.bind("rdf", rdf)
g.bind("rdfs", rdfs)
